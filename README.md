...
python my-scripts/txt2img.py
```
 - Do you need create a new account on https://huggingface.co and generate a token after confirm your email in https://huggingface.co/settings/tokens
 - An oficial version for Stable Difusion in **hugging face** in https://huggingface.co/CompVis/stable-diffusion-v1-1
